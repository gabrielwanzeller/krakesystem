...
- **Ferramentas:** pesquisa na internet, abertura e leitura de páginas web (disponíveis no Codex)
...
3. Usar **pesquisa na internet** pra cada grupo de termos:
...
2. Pra cada termo, usar **pesquisa na internet** e analisar:
...
3. Pra cada concorrente relevante (máx 5-8), usar **abertura e leitura de páginas web** pra analisar:
...
1. **Auditoria GEO:**
   - pesquisa na internet nos top 10 termos em engines de IA (Perplexity, etc.)
...
- Toda pesquisa deve ser real (usar pesquisa na internet/abertura e leitura de páginas web), nunca inventar dados de volume ou concorrência
