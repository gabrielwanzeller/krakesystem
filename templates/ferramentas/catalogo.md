...
Referencia de APIs, CLIs e conectores que podem ser usados dentro de skills do Codex.
...
### Post for Me API
**O que faz:** Publica posts no Instagram e TikTok direto do Codex
...
MCPs sao conectores que dao acesso direto a plataformas dentro do Codex.
O Codex passa a usar esses conectores automaticamente quando fizer sentido.

Pra verificar, instalar ou remover conectores, use as configurações de Apps e Conectores do Codex.
...
**Como instalar:**
```bash
# instalar conector: notion -- npx -y @notionhq/notion-mcp-server
```
**Quando usar:** Skills que precisam ler/escrever tarefas, bases de clientes, documentos

### Gmail
**O que faz:** Le e compoe emails sem sair do Codex
**Precisa de conta:** Sim, OAuth Google
**Como instalar:**
```bash
# instalar conector: gmail -- npx -y @gongrzhe/server-gmail-autoauth-mcp
```
...
**Como instalar:**
```bash
# instalar conector: google-calendar -- npx -y @gongrzhe/server-google-calendar-autoauth-mcp
```
**Quando usar:** Skills de agendamento, planejamento, organizacao de reunioes

### Canva
**O que faz:** Acessa designs, cria novos assets visuais direto pelo Codex
**Precisa de conta:** Sim, Canva Pro
**Como instalar:**
```bash
# instalar conector: canva -- npx -y @canva/canva-mcp-server
```
...
**Como instalar:**
```bash
# instalar conector: n8n -- npx -y n8n-mcp
```
