# [Nome da Empresa] — MazyOS

> Molde do AGENTS.md aplicado a **empresa estruturada** — setores,
...
Em projetos web novos, usar Next.js com App Router, React, TypeScript com
`strict: true`, Tailwind CSS e shadcn/ui. Seguir
`templates/sites/stack-padrao.md`. Preservar outra stack em projetos
existentes e só migrar ou abrir exceção com justificativa e aprovação.
